...
router.post('/', upload.single('file'), (req, res, next) => createAnnouncement(req, res, next));
router.patch('/:id', upload.single('file'), (req, res, next) => updateAnnouncement(req, res, next));
router.delete('/:id', (req, res, next) => deleteAnnouncement(req, res, next));
